        ...
        <ScrollArea className="h-screen">
          <div className="container mx-auto px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 pb-8">
              {recentProjects.map(project => <ProjectCard key={project.id} image={project.image} title={project.title} editedTime={project.editedTime} userInitial={project.userInitial} avatarColor={project.avatarColor} />)}
            </div>
          </div>
        </ScrollArea>
      </main>
