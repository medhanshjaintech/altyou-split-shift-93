  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      const mockResult: SearchResult = {
        ...
        articles: [
          "The History and Mysteries Behind the Topic",
          "Scientific Evidence and Research Findings",
          "Cultural Impact and Popular Media Representations"
        ],
  ...
  return (
    <div className="fixed inset-0 bg-[#121212] flex items-center justify-center">
      <ScrollArea className="h-full w-full">
        <div className="container mx-auto max-w-7xl px-6 py-[50px]">
          <div className="absolute top-10 left-10">
            <h3 className="text-white text-xl font-medium">Content Suggestion</h3>
          </div>
          
          <div className="flex flex-col w-full max-w-3xl mx-auto">
            <h2 className="text-white text-4xl md:text-5xl font-medium mb-8 text-center">What would you like to talk about today?</h2>
            ...
            <div className="w-full flex items-center mb-4">
              <Input 
                ...
                className="bg-white/10 border-0 text-white h-14 text-lg focus-visible:ring-white/40 placeholder:text-white/50 rounded-md" 
              />
              <Button 
                variant="ghost" 
                size="icon" 
