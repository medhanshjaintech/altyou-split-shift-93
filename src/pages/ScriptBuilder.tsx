          ...
          <div className="w-full max-w-5xl mx-auto pt-16">
            ...
            {generatedScript && !isEditing && (
              <div className="mt-8">
                ...
                <div className="flex justify-end gap-4 mt-6">
                  <Button variant="outline" onClick={handleDownloadScript} className="border-white/20 text-zinc-700 bg-zinc-100">
                    <Download className="h-4 w-4 mr-1" />
                    Download Script
                  </Button>
                  <Button className="bg-white/10 hover:bg-white/20 text-white border-0" onClick={handleEditScript}>
            ...
            {isEditing && generatedScript && (
              <div className="mt-8">
                ...
                <div className="flex justify-end gap-4 mt-6">
                  <Button variant="outline" className="text-white border-white/20 hover:bg-white/10" onClick={handleCancelEdit}>
                    Cancel
                  </Button>
                  <Button className="bg-white/10 hover:bg-white/20 text-white border-0" onClick={handleSaveEdits}>
                    Save Changes
                  </Button>
                </div>
              </div>
